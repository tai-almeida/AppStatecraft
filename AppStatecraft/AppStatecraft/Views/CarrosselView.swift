...
struct CarrosselView: View {
    ...
    let cards = [
        ...
        CardView(cor: Color(hex: 0x3b36a0), imagem: "Free-Writing", titulo: "Free-Writing", descricao: "Crie textos criativos a partir de um desafio dado, sem regras ou limitações.", destino: AnyView(InicialDMView())),
        CardView(cor: Color(hex: 0x377a95), imagem: "Ping-Pong", titulo: "Ping-Pong", descricao: "A partir de uma palavra, escreva todas as que vierem à mente em pouco tempo, sem parar", destino: AnyView(InicialDMView()))
    ]
