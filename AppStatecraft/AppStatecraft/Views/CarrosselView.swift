...
struct CarrosselView: View {
    ...
    let cards = [
        ...
        CardView(cor: Color(hex: 0x377a95), imagem: "Ping-Pong", titulo: "Ping-Pong", descricao: "A partir de uma palavra, escreva todas as que vierem à mente em pouco tempo, sem parar", destino: AnyView(PingPongView()))
    ]
